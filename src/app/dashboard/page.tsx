...
import { FiMessageSquare, FiTarget, FiTrendingUp, FiRefreshCcw, FiStar, FiUser, FiBook, FiSettings, FiMessageCircle, FiHelpCircle, FiLogOut, FiArrowLeft, FiTrash2 } from 'react-icons/fi'
...
export default function DashboardPage() {
  ...
  const handleDeleteClick = (chatId: string, e: React.MouseEvent) => {
    e.stopPropagation() // Prevent triggering the chat continuation
